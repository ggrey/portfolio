...
export const languages = {
	en:
	{
		...
		projects: {			
			...
			caf: "  Chicas al Frente is a costa rican feminist collective, they came to me needing a website featuring a blog, events (with image gallery) and a feminst economic network that would allow users to sign-up to have their product o service promoted.\n\n  It was built using GatsbyJS, Netlify's CMS (with fully customized fields and plugins) and Google's Firestore. Since we're talking about a non-profit organization, I selected tools that would drastically reduce maintenance costs (having free hosting with SSL, non-intrusive security update and generous free-tiers in third party apps).\n\n  This is a static website, it translates to super fast loads, more security and better SEO. It was optimized for mobile by providing some PWA (progressive web app) capabilities like the ability to work offline and a User Interface with 'app-like' feeling."
		},
		misc: {
			here: "here"
		}
