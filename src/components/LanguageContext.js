...
export const languages = {
	en:
	{
		...
		contact: {
			title: 'CONTACT',
			content: " Do you have a project you'd want me to jump in or want to get in touch? Shoot me a message filling the form below and I'll get back to you as soon as I can. Or email me directly at ggreype at gmail.com",
			name: "Name",
			subject: "Subject",
			message: "Message",
			required: "required",
	...
	es: {
		...
		contact: {
			title: 'CONTACTO',
			content: "¿Tiene algún proyecto en el que le gustaría que participe o quiere ponerse en contacto? Envíeme un mensaje llenando el formuario y responderé lo más pronto posible. O envíame un correo directamente a ggreype at gmail.com",
			name: "Nombre",
			subject: "Asunto",
			message: "Mensaje",
			required: "requerido",
