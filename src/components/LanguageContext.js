...
export const languages = {
	...
	es: {
		...
		experience: {
			intro: "  Empecé mi carrera como desarrolladora back-end, trabajando en bases de daños y diseño de arquitectura. He sido parte de equipos pequeños y grandes (distribuidos), ahí entendí lo crucial que resultan la documentación, versionamiento y la comunicación efectiva del equipo en pos de mantener flujos de trabajos sanos.\n\n Actualmente estoy trabajando como desarrolladora front-end y alcanzando una meta personal, la cual es sentirme cómoda en ambos lados del espectro para desarrollar aplicaciones desde cualquiera de sus frentes.",
